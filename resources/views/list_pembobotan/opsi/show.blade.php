  ...
  <div class="row">
    ...
    <div class="w-50">
      ...
      <div class="row">
        ...
        <div class="w-auto"><p>{{ $list_Pembobotan->l_max }}</p></div>
      </div>
      <div class="row">
        <div class="w-auto h-auto fw-semibold fs-6"><p>Consistency Index : </p></div>
        <div class="w-auto"><p>{{ $list_Pembobotan->c_index }}</p></div>
      </div>
      <div class="row">
        <div class="w-auto h-auto fw-semibold fs-6"><p>Consistency Ratio : </p></div>
        <div class="w-auto"><p>{{ $list_Pembobotan->c_ratio }}</p></div>
        @if($list_Pembobotan->c_ratio > 0.1)
